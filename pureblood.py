...
░░        ░░░ ░ ░   ░░   ░    ░       ░    ░   ░ ░   ░ ░ ░ ▒  ░ ░ ░ ▒   ░ ░  ░
            ░        ░        ░  ░    ░          ░  ░    ░ ░      ░ ░     ░                     _        _                _    _             
 /\ /\ _ __ ___   __ _(_)_ __  | |__   __ _  ___| | _(_)_ __   __ _ 
/ / \ \ '_ ` _ \ / _` | | '__| | '_ \ / _` |/ __| |/ / | '_ \ / _` |
\ \_/ / | | | | | (_| | | |    | | | | (_| | (__|   <| | | | | (_| |
 \___/|_| |_| |_|\__,_|_|_|    |_| |_|\__,_|\___|_|\_\_|_| |_|\__, |
                                                              |___/ 


     {2}--={3}[ {0}{5}Author: U.M.A.I.R                     {3}]{2}=--
{4}| {2}-- --={3}[ {0}{5}Version: 1                            {3}]{2}=-- -- {4}|
| {2}-- --={3}[ {0}{5}Website: https://github.com/Umair8906 {3}]{2}=-- -- {4}|
| {2}-- --={3}[ {0}{5}  {3}]{2}=-- -- {4}|
